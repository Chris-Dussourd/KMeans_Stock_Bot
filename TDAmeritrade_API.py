...
def get_orders(access_token,start_date,end_date,status):
    ...
    params = {'accountId':auth_info.account_num,
...
def get_order_by_id(access_token,order_ID):
    ...
    orders_url = 'https://api.tdameritrade.com/v1/accounts/{}/orders/{}'.format(auth_info.account_num,order_ID)
    headers={'Authorization': 'Bearer {}'.format(access_token)}
...
def post_order(access_token,json_request):
    ...
    """
    orders_url = 'https://api.tdameritrade.com/v1/accounts/{}/orders'.format(auth_info.account_num)
